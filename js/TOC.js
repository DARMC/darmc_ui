 ...
 "dojo/_base/sniff"], function(
   ...
   */
	...
	var _TOCNode = declare([_Widget, _Templated],{
		...
		'</span><span data-dojo-attach-point="pdNode" data-dojo-attach-event="onclick:_onClickPD"></span></span></div>' +
    ...
    _onClickPD: function(evt){
		...
		ioScript.get({
			...
			load: function(response, args){
				...
				//var foo = new esri.geometry.Extent(response.extent);

				//console.info(foo);
				//var zBtn = "<div dojoType='dijit/form/Button' onclick=map.setExtent(startExtent);>Zoom to layer <img src='images/zoom.png' width='13' height='13'></div>"
